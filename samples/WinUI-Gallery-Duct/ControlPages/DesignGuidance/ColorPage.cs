    ...
    static Element ApplyingThemeColorsSection() =>
        SampleCard("Applying Theme Colors",
            VStack(16,
                ...
                VStack(4,
                    Text("Accent colored text").Foreground(Theme.Accent),
                    Text("Primary text on any surface").Foreground(Theme.PrimaryText),
                    Text("Secondary text for captions").Foreground(Theme.SecondaryText),
                    Text("Tertiary text for placeholders").Foreground(Theme.TertiaryText),
                    Text("Hyperlink-style accent text").Foreground(Theme.AccentText)
                ),
                ...
                Text("Background")
                    .ApplyStyle("BodyStrongTextBlockStyle"),
                VStack(8,
                    Border(Text("SolidBackground — app page background").Foreground(Theme.PrimaryText).Margin(4))
                        .Background(Theme.SolidBackground)
                        .WithBorder(Theme.SurfaceStroke)
                        .CornerRadius(6),
                    Border(Text("CardBackground — elevated card surface").Foreground(Theme.PrimaryText).Margin(4))
                        .Background(Theme.CardBackground)
                        .WithBorder(Theme.CardStroke)
                        .CornerRadius(6),
                    Border(Text("LayerFill — flyout or dialog layer").Foreground(Theme.PrimaryText).Margin(4))
                        .Background(Theme.LayerFill)
                        .WithBorder(Theme.SurfaceStroke)
                        .CornerRadius(6),
                    Border(Text("SubtleFill — subtle highlight area").Foreground(Theme.PrimaryText).Margin(4))
                        .Background(Theme.SubtleFill)
                        .WithBorder(Theme.DividerStroke)
                        .CornerRadius(6),
                    Border(Text("Accent — primary action button fill").Foreground(Theme.Ref("TextOnAccentFillColorPrimaryBrush")).Margin(4))
                ...
                Text("Border & Stroke")
                    .ApplyStyle("BodyStrongTextBlockStyle"),
                VStack(8,
                    Border(Text("CardStroke border").Foreground(Theme.PrimaryText).Margin(4))
                        .Background(Theme.CardBackground)
                        .WithBorder(Theme.CardStroke)
                        .CornerRadius(6),
                    Border(Text("SurfaceStroke border").Foreground(Theme.PrimaryText).Margin(4))
                        .Background(Theme.LayerFill)
                        .WithBorder(Theme.SurfaceStroke)
                        .CornerRadius(6),
                    Border(Text("ControlStroke border").Foreground(Theme.PrimaryText).Margin(4))
                ...
                VStack(8,
                    Border(HStack(8,
                        ...
                        Text("Informational message").Foreground(Theme.PrimaryText)
                    ).Margin(4))
                    ...
                    Border(HStack(8,
                        ...
                        Text("Operation completed successfully").Foreground(Theme.PrimaryText)
                    ).Margin(4))
                    ...
                    Border(HStack(8,
                        ...
                        Text("Proceed with caution").Foreground(Theme.PrimaryText)
                    ).Margin(4))
                    ...
                    Border(HStack(8,
                        ...
                        Text("A critical error has occurred").Foreground(Theme.PrimaryText)
                    ).Margin(4))
            ...
            @"// Foreground
Text(""Accent text"").Foreground(Theme.Accent)
Text(""Primary"").Foreground(Theme.PrimaryText)
Text(""Secondary"").Foreground(Theme.SecondaryText)
Text(""Hyperlink"").Foreground(Theme.AccentText)
