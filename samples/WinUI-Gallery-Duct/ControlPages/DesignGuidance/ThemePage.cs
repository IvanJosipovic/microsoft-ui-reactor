...
namespace WinUIGalleryDuct.ControlPages.DesignGuidance;
...
class ThemePage : Component
{
    public override Element Render()
    {
        ...
        Element preview = Border(
            VStack(12,
                Text("Theme Preview").Foreground(Theme.PrimaryText).Bold().FontSize(16),
                ...
                Border(Text("Nested card").Margin(8).Foreground(Theme.PrimaryText))
                ...
                SampleCard("Theme Tokens Reference",
                    VStack(8,
                        HStack(8,
                            ...
                            Text("Theme.Accent — brand accent color").Foreground(Theme.PrimaryText).FontSize(13)),
                        HStack(8,
                            Border(VStack()).Background(Theme.CardBackground).WithBorder(Theme.CardStroke).Width(24).Height(24).CornerRadius(4),
                            Text("Theme.CardBackground — card surfaces").Foreground(Theme.PrimaryText).FontSize(13)),
                        HStack(8,
                            Border(VStack()).Background(Theme.SubtleFill).WithBorder(Theme.SurfaceStroke).Width(24).Height(24).CornerRadius(4),
                            Text("Theme.SubtleFill — subtle backgrounds").Foreground(Theme.PrimaryText).FontSize(13))
                    ),
