...
class TabViewPage : Component
{
    public override Element Render()
    {
        ...
        var tabs = Enumerable.Range(1, tabCount)
            .Select(i => Tab($"Tab {i}", Text($"Content of Tab {i}").Padding(16)))
            .ToArray();
        ...
        return ScrollView(
            VStack(16,
                ...
                SampleCard("Basic TabView",
                    (TabView(
                        Tab("Home", Text("Home content").Padding(16)),
                        Tab("Document", Text("Document content").Padding(16)),
                        Tab("Settings", Text("Settings content").Padding(16))
                    ) with
                    {
    ...
    Tab(""Document"", Text(""Document content"")),
    ...
    .Select(i => Tab($""Tab {i}"", Text($""Content {i}"")))
    .ToArray();
