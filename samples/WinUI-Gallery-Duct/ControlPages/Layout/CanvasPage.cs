            ...
            VStack(16,
                ...
                SampleCard("Interactive Positioning",
                    VStack(8,
                        Border(
                            Canvas(
                                Border(Text("Drag me!").Center().Foreground("#FFFFFF"))
                    ...
                    @"Border(Text(""Move"")).Canvas(left: offsetX, top: offsetY)",
                    OptionPanel(
                        Text("Left"), Slider(offsetX, 0, 200, setOffsetX),
                        Text("Top"), Slider(offsetY, 0, 100, setOffsetY)
                    ))
            ).Margin(36, 24, 36, 36)
        );
    }
