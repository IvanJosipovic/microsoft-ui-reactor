        ...
        return ScrollView(
            VStack(16,
                ...
                SampleCard("Basic Flyout",
                    Flyout(
                        Button("Show Flyout"),
                        Factories.Text("This is flyout content!").Padding(8)),
                    @"Flyout(
    Button(""Show Flyout""),
    Factories.Text(""This is flyout content!"").Padding(8))"),
                ...
                SampleCard("Flyout with Actions",
                    VStack(8,
                        Flyout(
                            Button("Cart Options"),
                            VStack(8,
                                Factories.Text("Your cart has items.").Foreground(Theme.PrimaryText),
                                Button("Empty Cart", () => setCount(0))
                            ).Padding(8)),
                        Factories.Text($"Cart count: {count}").Foreground(Theme.SecondaryText),
                        Button("Add Item", () => setCount(count + 1))
                    ),
                    @"Flyout(
    Button(""Cart Options""),
    VStack(8,
        Factories.Text(""Your cart has items.""),
        Button(""Empty Cart"", () => setCount(0)))
    .Padding(8))")
            ).Margin(36, 24, 36, 36)
        );
