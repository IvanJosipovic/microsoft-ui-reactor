...
/// WinForms test host (Duct.WinFormsTests.Host) instead of the WinUI host.
/// </summary>
public class WinFormsTestSession
{
    private const string WinAppDriverUrl = "http://127.0.0.1:4723";
    private const string WindowTitle = "WinForms Interop Test Host";
    private const string ProcessName = "Duct.WinFormsTests.Host";
    ...
    private static string FindHostExe()
    {
        ...
        var exe = Path.Combine(dir, "tests", "Duct.WinFormsTests.Host", "bin", platform,
