...
internal static class LocalizationFixtures
{
    ...
    /// <summary>
    /// Builds an InMemoryResourceProvider with translations for en-US, ko-KR, ar-SA, ja-JP, de-DE.
    /// Includes plural forms (ICU MessageFormat) and simple parameterised strings.
    /// </summary>
    ...
    internal class LocaleSwitching(Harness h) : FixtureBase(h)
    {
        public override async Task RunAsync()
        {
            ...
            host.Mount(ctx =>
            {
                ...
                // Create IntlAccessor directly — avoids LocaleProvider UseEffect timing
                // while still exercising the full localization pipeline: ICU MessageFormat,
                // resource resolution, RTL detection, and plural formatting.
                var t = ctx.UseMemo(() =>
                    new IntlAccessor(locale, resources, cache, "en-US"),
                    locale);

                // Flush message cache on locale change
                ...
                return VStack(8,
                    ...
                    // Main content panel — FlowDirection tracks the locale
                    VStack(8,
                        ...
                        // Direction label — verifies the resource itself knows the direction
            ...
            // Verify RTL-specific: FlowDirection on the content panel
