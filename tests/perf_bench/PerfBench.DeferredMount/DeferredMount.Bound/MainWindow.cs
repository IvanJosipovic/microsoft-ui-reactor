...
public sealed class MainWindow : Window
{
    ...
    {
        _opts = opts;
        Title = "EXP-9 DeferredMount.Bound";
        ...
        // Content area: all 5 tab panels, visibility toggled
        ...
        for (int t = 0; t < TabCount; t++)
        {
            ...
            {
                var vm = new TabItemViewModel(t, i);
        ...
        if (_opts.Headless)
        {
            ...
            {
                shutdown.Stop();
                _tracker.WriteReportFile("EXP9_DeferredMount_Bound");
                Close();
            };
            shutdown.Start();
        }
