...
public class StandardCommandTests
{
    ...
    public void Standard_Command_Has_Correct_Metadata(
        Command cmd, string expectedLabel, string? expectedIcon, VirtualKey? expectedKey, VirtualKeyModifiers? expectedModifiers)
    {
    ...
    public static TheoryData<Command, string, string?, VirtualKey?, VirtualKeyModifiers?> AllSyncCommands()
    {
        Action noop = () => { };
        var data = new TheoryData<Command, string, string?, VirtualKey?, VirtualKeyModifiers?>();
