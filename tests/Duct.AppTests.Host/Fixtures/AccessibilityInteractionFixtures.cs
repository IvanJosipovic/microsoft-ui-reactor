...
internal static class AccessibilityInteractionFixtures
{
    ...
    internal static Element LiveRegionStaticTest(RenderContext ctx)
    {
        ...
        return VStack(12,
            Text("Live Region Test")
                .HeadingLevel(AutomationHeadingLevel.Level1)
                .AutomationId("A11yLive_Title"),

            Text("Status: 3 items deleted")
    ...
    internal class UseAnnounceTestComponent : Component
    {
        public override Element Render()
        {
            ...
            return VStack(12,
                ...
                Text(count > 0 ? $"Last announcement: {count} items deleted" : "No announcements yet")
    ...
    internal static Element SemanticPanelTest(RenderContext ctx)
    {
        return VStack(12,
            ...
            HStack(4,
                Text("●").FontSize(10).Foreground("#00CC00"),
                Text("Online")
            ).Semantics(
                role: "statusbar",
                value: "Online"
