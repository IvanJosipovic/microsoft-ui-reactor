...
public class LogicalModifierTests
{
    ...
    public void ExtensionMethod_MarginInlineStart_SetsProperty()
    {
        ...
        var modified = Duct.ElementExtensions.MarginInlineStart(el, 16);
    ...
    {
        var el = new TextElement("Hello");
        var modified = Duct.ElementExtensions.PaddingInlineEnd(el, 8);
    ...
    {
        var el = new TextElement("Hello");
        var modified = Duct.ElementExtensions.MarginInlineEnd(
            Duct.ElementExtensions.MarginInlineStart(el, 16), 8);
