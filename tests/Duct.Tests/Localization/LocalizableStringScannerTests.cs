...
public class LocalizableStringScannerTests
{
    ...
    public void Ternary_BothBranchesExtracted()
    {
        var source = """
            class App : Component {
                public override Element Render() {
                    return Text(isVisible ? "Show" : "Hide");
                }
            }
            """;
    ...
    public void MessageCall_AlreadyWrapped_Skipped()
    {
        var source = """
            class App : Component {
                public override Element Render() {
                    return Text(t.Message(Loc.App.Hello));
                }
            }
            """;
    ...
    public void ExpanderHeader_Detected()
    {
        var source = """
            class Settings : Component {
                public override Element Render() {
                    return Expander("Advanced Settings", Text("Content"));
                }
            }
            """;
