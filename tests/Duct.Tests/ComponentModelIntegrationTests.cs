...
public class ComponentModelIntegrationTests : IDisposable
{
    ...
    private Element Mount(Component component,
        Dictionary<DuctContextBase, object?>? ctx = null,
    ...
    private static readonly DuctContext<int> CountCtx = new(0);
    private static readonly DuctContext<string> LocaleCtx = new("en-US");
    ...
    public void Nested_Components_Memo_With_Context_Change()
    {
        ...
        _scope.Push(new Dictionary<DuctContextBase, object?> { [ThemeCtx] = "blue" });
    ...
    public void Multiple_Contexts_And_State_Coexist()
    {
        ...
        var ctxValues = new Dictionary<DuctContextBase, object?>
        {
            [ThemeCtx] = "dark",
            [CountCtx] = 5,
            [LocaleCtx] = "fr-FR",
        ...
        // Change one context
        var newCtxValues = new Dictionary<DuctContextBase, object?>
        {
            [ThemeCtx] = "dark",
            [CountCtx] = 99, // changed
            [LocaleCtx] = "fr-FR",
    ...
    public void Context_Shadowing_Through_Component_Hierarchy()
    {
        ...
        // Outer sees "dark"
        _scope.Push(new Dictionary<DuctContextBase, object?> { [ThemeCtx] = "dark" });
        Mount(outer);
        Assert.Equal("dark", outer.Theme);

        // Inner sees "high-contrast" (shadows outer)
        _scope.Push(new Dictionary<DuctContextBase, object?> { [ThemeCtx] = "high-contrast" });
        Mount(inner);
