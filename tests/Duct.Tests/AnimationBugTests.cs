...
public class AnimationBugTests
{
    ...
    {
        var el = Text("Hello").Scale(new Vector3(1, 2, 1));
        Assert.NotNull(el.Modifiers);
    ...
    {
        var el = Text("Hello").Rotation(90f);
        Assert.NotNull(el.Modifiers);
    ...
    {
        var el = Text("Hello").Translation(10, 20, 5);
        Assert.NotNull(el.Modifiers);
    ...
    {
        var el = Text("Hello").CenterPoint(new Vector3(50, 50, 0));
        Assert.NotNull(el.Modifiers);
