...
public class PanelChildReconciliationTests
{
    ...
    {
        var el = VStack(Text("A"), null, Text("B"), null);
    ...
    {
        var el = HStack(null, Text("A"), null);
    ...
    {
        var el = UI.Flex(Text("A"), null, Text("B"), null, Text("C"));
    ...
    {
        var el = FlexRow(null, null, Text("A"));
        Assert.Single(el.Children);
    }
    ...
    {
        var el = FlexColumn(null, Text("A"), null);
        Assert.Single(el.Children);
    }
    ...
    {
        var el = Grid(["*", "*"], ["*"], Text("A"), null, Text("B"));
        Assert.Equal(2, el.Children.Length);
    }
    ...
    {
        var el = Canvas(null, Text("A"), null);
        Assert.Single(el.Children);
    }
    ...
    {
        var el = RelativePanel(Text("A"), null, Text("B"));
        Assert.Equal(2, el.Children.Length);
    }
    ...
    {
        var reconciler = new Reconciler();
        Assert.True(reconciler.CanUpdate(VStack(Text("A")), VStack(Text("B"))));
        Assert.True(reconciler.CanUpdate(HStack(Text("A")), HStack(Text("B"))));
    }
    ...
    {
        var reconciler = new Reconciler();
        Assert.True(reconciler.CanUpdate(UI.Flex(Text("A")), UI.Flex(Text("B"))));
        Assert.True(reconciler.CanUpdate(FlexRow(Text("A")), FlexColumn(Text("B"))));
    }
    ...
    {
        var reconciler = new Reconciler();
        Assert.True(reconciler.CanUpdate(WrapGrid(Text("A")), WrapGrid(Text("B"))));
    }
    ...
    {
        var reconciler = new Reconciler();
        Assert.True(reconciler.CanUpdate(Canvas(Text("A")), Canvas(Text("B"))));
    }
    ...
    {
        var reconciler = new Reconciler();
        Assert.True(reconciler.CanUpdate(RelativePanel(Text("A")), RelativePanel(Text("B"))));
    }
    ...
    {
        var reconciler = new Reconciler();
        Assert.False(reconciler.CanUpdate(VStack(Text("A")), UI.Flex(Text("A"))));
        Assert.False(reconciler.CanUpdate(UI.Flex(Text("A")), WrapGrid(Text("A"))));
        Assert.False(reconciler.CanUpdate(WrapGrid(Text("A")), Canvas(Text("A"))));
    ...
    {
        var a = FlexRow(Text("A"));
        var b = FlexColumn(Text("A"));
        Assert.False(Element.ShallowEquals(a, b));
    }
...
public class YogaWinUILayoutInteractionTests
{
    ...
    {
        var root = new YogaNode();
        root.FlexDirection = Duct.Flex.FlexDirection.Row;
        root.Width = YogaValue.Point(300);
        root.Height = YogaValue.Point(100);

        var child0 = new YogaNode { FlexGrow = 1 };
        root.InsertChild(child0, 0);
        root.CalculateLayout(300, 100, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    {
        var root = new YogaNode();
        root.CalculateLayout(float.NaN, float.NaN, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void Layout_Add_Single_Child_To_Empty()
    {
        ...
        root.InsertChild(child, 0);
        root.CalculateLayout(200, 100, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void Measure_Then_Arrange_Produces_Consistent_Results()
    {
        ...
        var root = new YogaNode();
        root.FlexDirection = Duct.Flex.FlexDirection.Column;
        ...
        root.CalculateLayout(100, 200, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void MeasureFunction_Receives_Constraints()
    {
        ...
        Duct.Layout.YogaMeasureMode receivedWMode = (Duct.Layout.YogaMeasureMode)(-1);
        ...
        root.InsertChild(child, 0);
        root.CalculateLayout(100, 50, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void FlexShrink_Shrinks_Children_When_Overflowing()
    {
        ...
        root.InsertChild(child0, 0);
        root.InsertChild(child1, 1);
        root.CalculateLayout(200, float.NaN, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void FlexBasis_Overrides_Width_For_Grow()
    {
        ...
        root.InsertChild(child0, 0);
        root.InsertChild(child1, 1);
        root.CalculateLayout(300, float.NaN, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void AlignItems_Center_Centers_Cross_Axis()
    {
        var root = new YogaNode();
        root.FlexDirection = Duct.Flex.FlexDirection.Row;
        root.AlignItems = Duct.Flex.FlexAlign.Center;
        root.Width = YogaValue.Point(200);
        root.Height = YogaValue.Point(100);
    ...
    public void JustifyContent_SpaceBetween_Distributes_Space()
    {
        var root = new YogaNode();
        root.FlexDirection = Duct.Flex.FlexDirection.Row;
        root.JustifyContent = Duct.Flex.FlexJustify.SpaceBetween;
        root.Width = YogaValue.Point(300);
        root.Height = YogaValue.Point(50);
        ...
        root.InsertChild(child1, 1);
        root.InsertChild(child2, 2);
        root.CalculateLayout(300, 50, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void FlexWrap_Wraps_Children_To_Next_Line()
    {
        var root = new YogaNode();
        root.FlexDirection = Duct.Flex.FlexDirection.Row;
        root.FlexWrap = Duct.Flex.FlexWrap.Wrap;
        root.Width = YogaValue.Point(200);
    ...
    public void Gap_Adds_Spacing_Between_Children()
    {
        ...
        root.Width = YogaValue.Point(300);
        root.Height = YogaValue.Point(50);
        root.SetGap(Duct.Layout.YogaGutter.Column, 20);
    ...
    public void Layout_Column_Direction_Child_Count_Change()
    {
        ...
        var child0 = new YogaNode { FlexGrow = 1 };
        root.InsertChild(child0, 0);
        root.CalculateLayout(100, 300, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void Padding_Reduces_Available_Space_For_Children()
    {
        ...
        root.Width = YogaValue.Point(200);
        root.Height = YogaValue.Point(100);
        root.SetPadding(Duct.Layout.YogaEdge.Left, YogaValue.Point(20));
        root.SetPadding(Duct.Layout.YogaEdge.Right, YogaValue.Point(20));
    ...
    public void Margin_Offsets_Child_Position()
    {
        ...
        child.Width = YogaValue.Point(50);
        child.Height = YogaValue.Point(50);
        child.SetMargin(Duct.Layout.YogaEdge.Left, YogaValue.Point(10));
        child.SetMargin(Duct.Layout.YogaEdge.Top, YogaValue.Point(15));
        root.InsertChild(child, 0);
        root.CalculateLayout(200, 100, Duct.Flex.FlexLayoutDirection.LTR);
    ...
    public void RTL_Reverses_Child_Order()
    {
        ...
        root.CalculateLayout(300, 100, Duct.Flex.FlexLayoutDirection.RTL);
    ...
    {
        var el = UI.Flex(Text("A"));
        Assert.Equal(Duct.Flex.FlexDirection.Row, el.Direction);
        Assert.Equal(Duct.Flex.FlexJustify.FlexStart, el.JustifyContent);
        Assert.Equal(Duct.Flex.FlexAlign.Stretch, el.AlignItems);
        Assert.Equal(Duct.Flex.FlexAlign.FlexStart, el.AlignContent);
        Assert.Equal(Duct.Flex.FlexWrap.NoWrap, el.Wrap);
    ...
    {
        var el = FlexColumn(Text("A"));
        Assert.Equal(Duct.Flex.FlexDirection.Column, el.Direction);
    }

    [Fact]
    public void FlexElement_WithInit_Overrides()
    {
        var el = UI.Flex(Text("A")) with
        {
            Direction = Duct.Flex.FlexDirection.ColumnReverse,
            JustifyContent = Duct.Flex.FlexJustify.SpaceAround,
            AlignItems = Duct.Flex.FlexAlign.Center,
            Wrap = Duct.Flex.FlexWrap.Wrap,
            ColumnGap = 10,
            RowGap = 20,
        };
        Assert.Equal(Duct.Flex.FlexDirection.ColumnReverse, el.Direction);
        Assert.Equal(Duct.Flex.FlexJustify.SpaceAround, el.JustifyContent);
        Assert.Equal(Duct.Flex.FlexAlign.Center, el.AlignItems);
        Assert.Equal(Duct.Flex.FlexWrap.Wrap, el.Wrap);
    ...
    public void Absolute_Position_Child_Does_Not_Affect_Siblings()
    {
        ...
        {
            PositionType = Duct.Flex.FlexPositionType.Absolute,
            Width = YogaValue.Point(50),
            Height = YogaValue.Point(50),
        };
        absChild.Style.Position[(int)Duct.Layout.YogaEdge.Left] = YogaValue.Point(10);
        absChild.Style.Position[(int)Duct.Layout.YogaEdge.Top] = YogaValue.Point(10);
