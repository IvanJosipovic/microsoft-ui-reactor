...
///   WF_TextBox1 → WF_Button1 → WF_TextBox2 → [Island] → Duct_TextField1 →
///   Duct_Button1 → Duct_TextField2 → [exit island] → WF_TextBox3 → wrap
/// </summary>
class TestForm : SWF.Form
{
    public TestForm()
    {
        ...
        var island = new XamlIslandControl
        {
            ...
            TabIndex = 1,
            ComponentType = typeof(TestDuctComponent),
        };
