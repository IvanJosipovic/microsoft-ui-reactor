...
{
    /// <summary>The Duct modifier method name (e.g., "AutomationName").</summary>
...
/// <summary>
/// Post-reconciliation accessibility scanner that walks the Duct virtual
/// element tree and produces structured diagnostics. Intended for DEBUG
/// builds only — call via <see cref="DuctHostControl.EnableAccessibilityDiagnostics"/>.
///
