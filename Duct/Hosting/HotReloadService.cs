...
[assembly: MetadataUpdateHandler(typeof(Duct.HotReloadService))]

namespace Duct;

/// <summary>
/// Hooks into .NET Hot Reload (Visual Studio / dotnet watch).
/// When code is edited, triggers a re-render on the active DuctHost.
...
static class HotReloadService
{
    ...
    {
        DuctApp.ActiveHost?.RequestRender();
    }
}
