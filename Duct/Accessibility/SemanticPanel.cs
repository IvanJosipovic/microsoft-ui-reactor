...
namespace Duct.Accessibility;

/// <summary>
/// A lightweight WinUI Panel that provides custom automation semantics for
/// composite Duct components. Wraps a single child and overrides
/// OnCreateAutomationPeer() to expose a custom role, value, and range to
/// screen readers.
///
/// This solves the fundamental limitation where Duct components (C# records)
