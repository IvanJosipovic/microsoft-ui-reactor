...
using DuctComponent = Duct.Core.Component;
...
///   3. <see cref="ComponentType"/> — set a Duct Component type. The control
///      creates the DuctHostControl and mounts the component automatically at
...
public class XamlIslandControl : SWF.Control
{
    ...
    ///
    /// Example:
    ///   island.ContentFactory = () => new DuctHostControl(new MyComponent());
    /// </summary>
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    [Browsable(false)]
    ...
    /// <summary>
    /// A Duct Component type to host. The control creates a DuctHostControl and
    /// mounts an instance of this type automatically at runtime.
    ///
    /// The type must be a concrete subclass of <see cref="DuctComponent"/> with
    ...
    [Browsable(true)]
    [Category("Duct")]
    [Description("The Duct Component type to host. Creates a DuctHostControl automatically at runtime.")]
    [TypeConverter(typeof(DuctComponentTypeConverter))]
    [DefaultValue(null)]
    ...
    private void MountComponentType(Type type)
    {
        ...
        var component = (DuctComponent)Activator.CreateInstance(type)!;
        _source.Content = new DuctHostControl(component);
    }
