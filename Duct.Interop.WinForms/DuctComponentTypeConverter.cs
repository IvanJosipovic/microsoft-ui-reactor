...
///   - Show a dropdown of all concrete Duct Component subclasses in the project
///   - Accept typed type names and resolve them to Type objects
/// </summary>
internal class DuctComponentTypeConverter : TypeConverter
{
    ...
    private static bool IsValidComponentType(Type t)
        => t.IsClass
        && !t.IsAbstract
        && typeof(DuctComponent).IsAssignableFrom(t)
